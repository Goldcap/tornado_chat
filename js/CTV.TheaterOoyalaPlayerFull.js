var CTV = CTV || {};
CTV.TheaterOoyalaPlayerFull = function(options, domNode) {
	this.options = $.extend({
...
CTV.TheaterOoyalaPlayerFull.prototype = {
	...
	resize: function(height){
		this.domNode.css({height: height - 60});
	},
	initPlayer: function() {
		...
		$(document.body).append('<script src="http://player.ooyala.com/player.js?width=640&height=360&embedCode='+ this.options.ooyalaEmbedId +'&videoPcode=F0YW06tUyoXE3Itr8QKSPI9aTQWr&targetReplaceId=movie-placeholder&callback=receiveOoyalaEvent"></script>')
 ...
 //    },
	...
	onVideoComplete: function(event){
		this.domNode.empty();
		$(this).trigger('videoCompleteDohbr', true)
	}
}